...
type Integration = { id: number; name: string; Icon: FC };
...
const IntegrationsSection = () => {
    const integrations: Integration[] = [
        { id: 1, name: 'Google Workspace', Icon: IconGoogle },
        { id: 2, name: 'Microsoft 365', Icon: IconMicrosoft },
        { id: 3, name: 'Slack', Icon: IconSlack },
        { id: 4, name: 'SMTP/IMAP', Icon: IconSMTP },
        { id: 5, name: 'Webhooks', Icon: IconWebhooks },
    ];
